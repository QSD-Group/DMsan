...
gates_path = os.path.dirname(__file__)
scores_path = os.path.join(gates_path, 'scores')
results_path = os.path.join(gates_path, 'results')
figures_path = os.path.join(gates_path, 'figures')
