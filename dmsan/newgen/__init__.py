...
newgen_path = os.path.dirname(__file__)
scores_path = os.path.join(newgen_path, 'scores')
results_path = os.path.join(newgen_path, 'results')
figures_path = os.path.join(newgen_path, 'figures')
